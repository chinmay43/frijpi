...
console.log(sysFsPath);
sysFsPath = "/sys/class/gpio", // post 3.18.x kernel
...
function handleExecResponse(method, pinNumber, callback) {
	return function(err, stdout, stderr) {
		if (err) {
			...
			console.log("No error in handling exec response");
			callback();
		}
	}
}
...
var gpio = {
	...
	open: function(pinNumber, options, callback) {
		console.log(pinNumber + " " + JSON.stringify(options));
		...
		console.log("SaneOptions " + JSON.stringify(options)); 

		exec("gpio-admin" + " export " + "15", handleExecResponse("open", pinNumber, function(err) {
			console.log("hER"+err);
		}));
		exec(gpioAdmin + " export " + pinMapping[pinNumber] + " " + options.pull, handleExecResponse("open", pinNumber, function(err) {
			console.log("Error : " + err);
			console.log(pinNumber + " " + JSON.stringify(pinMapping)  + JSON.stringify(options));
